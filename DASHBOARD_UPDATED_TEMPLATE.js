// FILE: src/Admin/Dashboard_Updated.js
// GUNAKAN INI UNTUK REPLACE Dashboard.js YANG LAMA
...
function Dashboard() {
  ...
  useEffect(() => {
    const pending = absensiData?.filter(a => a.status === "Menunggu")?.length || 0;
    ...
    <main className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 card-hover animate-slide-up" style={{ animationDelay: '0.1s' }}>
          ...
          <p className="text-2xl font-bold text-gray-900">{karyawanData?.length || 0}</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 card-hover animate-slide-up" style={{ animationDelay: '0.2s' }}>
          <div className="flex items-center justify-between mb-3">
            ...
            <svg className="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
              <path d="M8.16 2.75a.75.75 0 00-1.32 0l-1.4 3.5H1.75a.75.75 0 000 1.5h3.26l-1.4 3.5a.75.75 0 001.32 0l1.4-3.5h3.26a.75.75 0 000-1.5H7.54l1.4-3.5zm3.68 3.5a.75.75 0 00-1.32 0l-1.4 3.5h3.26l-1.4-3.5z" />
            </svg>
          </div>
